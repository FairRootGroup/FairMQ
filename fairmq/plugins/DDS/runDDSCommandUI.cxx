...
int main(int argc, char* argv[])
{
    try {
        ...
        if (vm.count("help")) {
            ...
            cout << "Commands: [c] check state, [o] dump config, [h] help, [p] pause, [r] run," << endl
                 << "          [s] stop, [t] reset task, [d] reset device, [q] end, [j] init task," << endl
                 << "          [i] init device, [q!] shutdown sequence, [r!] startup sequence" << endl;
            return EXIT_SUCCESS;
        }
